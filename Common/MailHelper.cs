...
namespace Common
{
    public static class MailHelper
    {
        ...
        public static void SendMail(string reciver, string subject, string content)
        {
            try
            {
                MailMessage message = new MailMessage("zhang1287609286@qq.com", reciver, subject, content);
                message.IsBodyHtml = true;
                SmtpClient client = new SmtpClient("smtp.qq.com", 25);
                client.Credentials = new NetworkCredential("zhang1287609286@qq.com", "kxyqycxqgywdgiec");
